var ArivocCourseRead = (function(win, $, ArivocPlayer, ArivocRecorder) {
    ...
    var ACR = function(selector, option) {
        ...
        var targetobj = this,
            cookie = null,
            interval = 50;
        var lessonId, courseUrl, cnTextShow = "1",
            isMerge = "0",
            isWordLesson = false;
        var readType = -1,
            targetScore = 0,
            ...
            curRole = null,
            temSteps = null;
        var isReciteWork = config.recite != null,
            reciteLessonId = config.getLessonId(),
            reciteWords = null;
        var lessonData = null,
            analysisServer = null,
            eppathServer = "recstatic.kouyu100.com",
            sentenceIndex = -1,
            finished = false,
            attachData = null,
            immeover = false;
        ...
        function on_play_feedback_started() {
            ...
            switch (sentence.data("errorcode")) {
                case -102:
                    feedbackAudio = config.teacherServer + "guide/cannothear.mp3";
                    break;
                case -103:
                    feedbackAudio = config.teacherServer + "guide/pass.mp3";
                    break;
                case -104:
                    feedbackAudio = config.teacherServer + "guide/norecord.mp3";
                    break;
                case -105:
                    feedbackAudio = config.teacherServer + "guide/refuse.mp3";
                    break;
                default:
        ...
        function on_finished() {
            ...
            submitReadResult({
                score: recScore,
                realScore: parseInt(82 + Math.random() * 12),
            ...
            switch (config.type) {
                case 8:
                    if (readType == 11 || readType == 12) {
                        if (saveRes == "0") {} else if (saveRes == "-1") {
